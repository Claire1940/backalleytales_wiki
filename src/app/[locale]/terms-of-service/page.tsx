...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Back Alley Tales Wiki",
    description: "Read the Terms of Service for Back Alley Tales Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Back Alley Tales Wiki",
      description: "Terms and conditions for using Back Alley Tales Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Back Alley Tales Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Back Alley Tales Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Back Alley Tales Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Back Alley Tales Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the game "Back Alley Tales". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and story walkthroughs</li>
              <li>Character and story guides</li>
            ...
            <p>
              <strong>Important:</strong> Back Alley Tales Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Back Alley Tales. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Back Alley Tales Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Back Alley Tales. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Game content and updates may change without notice. We are not responsible for access issues or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BACK ALLEY TALES WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Back Alley Tales Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@backalleytales.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@backalleytales.wiki</a>
            </p>
            <p>
