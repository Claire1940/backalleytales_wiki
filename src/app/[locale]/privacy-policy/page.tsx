...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Back Alley Tales Wiki',
    description: 'Back Alley Tales Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Back Alley Tales Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Back Alley Tales Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Valve Corporation (Steam) or the developers of Back Alley Tales. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@backalleytales.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@backalleytales.wiki</a>
            </p>
            <p>
